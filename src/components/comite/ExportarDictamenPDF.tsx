...
export function ExportarDictamenPDF({ dictamen, expediente, clienteNombre }: Props) {
  ...
  return (
    <button
      onClick={exportar}
      className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 transition-colors hover:border-fieldcredit-green hover:text-fieldcredit-green sm:flex-none dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300 dark:hover:border-fieldcredit-green dark:hover:text-fieldcredit-green"
