      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className={cn("space-y-3", vistaMovil === "mapa" && "hidden lg:block")}>
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <button
                  ...
                  className="h-11 flex-1 rounded-lg bg-amber-500 px-4 text-sm font-bold text-white"
                >
                  Guardar coordenadas
                </button>
                <button
                  onClick={() => setModoManual(null)}
                  className="h-11 w-full rounded-lg border border-slate-300 px-4 text-sm text-slate-600 dark:border-slate-600 dark:text-slate-300 sm:w-auto"
                >
                  Cancelar
                </button>
              </div>
          ...
          <button
            ...
            className="h-11 w-full rounded-lg border border-dashed border-slate-300 text-xs text-slate-500 hover:bg-slate-50 dark:border-slate-600 dark:hover:bg-slate-800"
          >
        ...
        <div className={cn("space-y-3", vistaMovil === "captura" && "hidden lg:block")}>
          <div className="aspect-video w-full overflow-hidden rounded-xl border border-slate-200 dark:border-slate-700 lg:aspect-auto lg:h-[460px]">
            <Suspense
              fallback={
